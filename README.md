...
**UI/UX:** Material Design, Cupertino, Custom Animations, Lottie  
**Local Storage:** Hive, SharedPreferences, SQLite  
**Integrations:** Stripe Payments, In-App Purchases, Google Maps, Push Notifications (FCM), Deep Linking, WebView, Speech-to-Text, Audio Recording, Plaid API  
**Testing:** Unit Testing, Widget Testing, Mockito
...
## 👨‍💼 Experience
**Technical Interviewing:** Active in evaluating software engineering candidates, assessing coding skills, system design thinking, and technical communication.
